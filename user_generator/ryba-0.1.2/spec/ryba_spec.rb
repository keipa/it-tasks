...
describe "Ryba" do
  describe "Name" do
    ...
    it "should work for male" do
      ...
      @name.full_name(true)
      @name.first_nameBY(true)
      @name.middle_nameBY(true)
      @name.family_nameBY(true)
      @name.full_nameBY(true)
    end
    ...
    it "should work for female" do
      ...
      @name.first_nameBY(false)
      @name.middle_nameBY(false)
      @name.family_nameBY(false)
      @name.full_nameBY(false)
    end
    ...
    it "should work with random gender" do
      @name.gender do |gender|
        ...
        @name.first_nameBY(gender)
        @name.middle_nameBY(gender)
        @name.family_nameBY(gender)
        @name.full_nameBY(gender)
      end
    end
  end
